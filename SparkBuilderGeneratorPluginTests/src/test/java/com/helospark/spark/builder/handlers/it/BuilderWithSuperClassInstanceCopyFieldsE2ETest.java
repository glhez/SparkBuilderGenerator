...
public class BuilderWithSuperClassInstanceCopyFieldsE2ETest extends BaseBuilderGeneratorIT {
    ...
    public void testSimpleExtends(String inputFile, String superClassFile, String expectedOutputFile) throws Exception {
        // GIVEN
        TypeExtractorAnswerProvider typeExtractorAnswerProvider = new TypeExtractorAnswerProvider(
                Collections.singletonMap("TestClass", firstSuperClassType));
        given(iTypeExtractor.extract(any(TypeDeclaration.class)))
                                                                 .willAnswer(typeExtractorAnswerProvider::provideAnswer);
    ...
    public Object[][] simpleExtendsDataProvider() {
        return new Object[][] {
                { "superclass_instance_copy/1_base_child_input.tjava", "superclass_instance_copy/1_base_super_input.tjava",
                        "superclass_instance_copy/1_base_output.tjava" },
                { "superclass_instance_copy/2_base_child_input.tjava", "superclass_instance_copy/2_base_super_input.tjava",
                        "superclass_instance_copy/2_base_output.tjava" },
                { "superclass_instance_copy/3_base_child_input.tjava", "superclass_instance_copy/3_base_super_input.tjava",
                        "superclass_instance_copy/3_base_output.tjava" },
                { "superclass_instance_copy/4_base_child_input.tjava", "superclass_instance_copy/4_base_super_input.tjava",
                        "superclass_instance_copy/4_base_output.tjava" },
        };
    }
