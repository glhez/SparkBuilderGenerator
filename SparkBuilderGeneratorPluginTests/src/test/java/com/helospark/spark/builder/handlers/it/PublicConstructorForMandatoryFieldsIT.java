...
public class PublicConstructorForMandatoryFieldsIT extends BaseBuilderGeneratorIT {
    ...
    public Object[][] regularBuilderExampleFileProvider() {
        return new Object[][] {
                { "public_constructor_with_mandatory_fields/gh_input.tjava", "public_constructor_with_mandatory_fields/gh_output.tjava",
                        new boolean[] { true, false, false } },
                { "public_constructor_with_mandatory_fields/gh_input.tjava",
                        "public_constructor_with_mandatory_fields/gh_output_when_none_selected.tjava", new boolean[] { false, false, false } },
                { "public_constructor_with_mandatory_fields/gh_input.tjava",
                        "public_constructor_with_mandatory_fields/gh_output_when_all_selected.tjava", new boolean[] { true, true, true } },
        };
    }
