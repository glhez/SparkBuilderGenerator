...
public class BuilderInstanceCopyIT extends BaseBuilderGeneratorIT {
    ...
    public void testCopyMethodForRegularBuilderWhenChangingDialogSetting(String inputFile, String expectedOutputFile, boolean dialogPreference)
            throws Exception {
        // GIVEN
        ...
        RegularBuilderFilterDialogAnswerProvider regularBuilderFilterDialogAnswerProvider = new RegularBuilderFilterDialogAnswerProvider(
                asList(0, 1, 2, 3, 4), dialogPreference);
