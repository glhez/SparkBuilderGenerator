...
public class DiContainer {
    public static final List<Object> diContainer = new ArrayList<>();
    ...
    public static void initializeDiContainer() {
        ...
        addDependency(new BuiltInCollectionsInitializerChainitem(getDependency(StaticMethodInvocationFragment.class),
                getDependency(PreferencesManager.class)));
        ...
        addDependency(new StaticBuilderMethodSignatureGeneratorFragment(getDependency(GeneratedAnnotationPopulator.class),
                getDependency(PreferencesManager.class)));
