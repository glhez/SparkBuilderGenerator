...
public class FieldDeclarationPostProcessor {
    ...
    public VariableDeclarationFragment postProcessFragment(AST ast, BuilderField builderField,
            VariableDeclarationFragment variableDeclarationFragment) {
        Expression defaultValue = builderField.getDefaultValue();

        if (defaultValue != null && preferencesManager.getBooleanPreference(INITIALIZE_BUILDER_FIELD_WITH_DEFAULT_VALUE)) {
    ...
    private boolean isPostProcessingWithEmptyDefaultValueRequired() {
        return preferencesManager.getBooleanPreference(INITIALIZE_OPTIONAL_FIELDS_TO_EMPTY)
                || preferencesManager.getBooleanPreference(INITIALIZE_COLLECTIONS_TO_EMPTY_COLLECTIONS);
    }
    ...
    private void postProcessUsingChainItem(AST ast, FieldDeclarationPostProcessorChainItem chainItemToUse,
            VariableDeclarationFragment variableDeclarationFragment,
