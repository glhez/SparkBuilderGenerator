...
public class StagedBuilderInterfaceNameProvider {
    ...
    public StagedBuilderInterfaceNameProvider(PreferencesManager preferencesManager, CamelCaseConverter camelCaseConverter,
    ...
    public String provideInterfaceNameFrom(BuilderField builderField) {
        String stageBuilderInterfaceNameTemplate = preferencesManager.getStringPreference(STAGED_BUILDER_STAGE_INTERFACE_NAME);
    ...
    public String provideBuildStageInterfaceName() {
        String stageBuilderInterfaceNameTemplate = preferencesManager.getStringPreference(STAGED_BUILDER_LAST_STAGE_INTERFACE_NAME);
