...
public class BuildMethodDeclarationCreatorFragment {
    ...
    public MethodDeclaration createMethod(AST ast, AbstractTypeDeclaration originalType) {
        ...
        if (preferencesManager.getBooleanPreference(ADD_NONNULL_ON_RETURN)) {
    ...
    private String getBuildMethodName(AbstractTypeDeclaration originalType) {
        ...
        return templateResolver.resolveTemplate(preferencesManager.getStringPreference(BUILD_METHOD_NAME_PATTERN),
                                                replacementMap);
    }
}
