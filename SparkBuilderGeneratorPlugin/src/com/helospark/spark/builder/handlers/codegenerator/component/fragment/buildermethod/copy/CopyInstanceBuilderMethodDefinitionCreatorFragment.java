...
public class CopyInstanceBuilderMethodDefinitionCreatorFragment {
    ...
    public CopyInstanceBuilderMethodDefinitionCreatorFragment(TemplateResolver templateResolver, PreferencesManager preferenceManager,
    ...
    private String getBuilderMethodName(AbstractTypeDeclaration originalType) {
        ...
        return templateResolver.resolveTemplate(preferenceManager.getStringPreference(COPY_INSTANCE_BUILDER_METHOD_PATTERN), replacements);
    }
