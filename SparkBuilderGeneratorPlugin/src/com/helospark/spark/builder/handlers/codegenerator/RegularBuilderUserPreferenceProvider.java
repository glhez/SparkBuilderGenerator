...
public class RegularBuilderUserPreferenceProvider {
    ...
    public RegularBuilderUserPreferenceProvider(RegularBuilderUserPreferenceDialogOpener regularBuilderUserPreferenceDialogOpener,
            ...
            RegularBuilderDialogDataConverter regularBuilderDialogDataConverter,
            RegularBuilderUserPreferenceConverter regularBuilderUserPreferenceConverter) {
    ...
    public Optional<RegularBuilderUserPreference> getPreference(List<BuilderField> builderFields) {
        ...
        if (preferencesManager.getBooleanPreference(REGULAR_BUILDER_SHOW_DIALOG)) {
    ...
    private RegularBuilderUserPreference createDefaultPreference(List<BuilderField> builderFields) {
        return RegularBuilderUserPreference.builder()
                                           ...
                                           .withGenerateCopyMethod(preferencesManager.getBooleanPreference(CREATE_METHOD_TO_INSTANTIATE_BUILDER_BASED_ON_INSTANCE))
                                           .withAddJacksonDeserializer(preferencesManager.getBooleanPreference(ADD_JACKSON_DESERIALIZE_ANNOTATION))
                                           .withCreateDefaultConstructor(preferencesManager.getBooleanPreference(CREATE_PUBLIC_DEFAULT_CONSTRUCTOR))
                                           .withCreatePublicConstructorWithMandatoryFields(preferencesManager.getBooleanPreference(CREATE_PUBLIC_CONSTRUCTOR_WITH_MANDATORY_FIELDS))
                                           .build();
    }
