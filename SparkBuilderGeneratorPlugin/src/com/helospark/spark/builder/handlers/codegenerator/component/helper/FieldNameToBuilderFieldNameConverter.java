...
public class FieldNameToBuilderFieldNameConverter {
    ...
    public FieldNameToBuilderFieldNameConverter(PreferencesManager preferencesManager,
            FieldPrefixSuffixPreferenceProvider fieldPrefixSuffixPreferenceProvider,
    ...
    public String convertFieldName(String rawFieldName) {
        ...
        if (preferencesManager.getBooleanPreference(REMOVE_PREFIX_AND_SUFFIX_FROM_BUILDER_NAMES)) {
