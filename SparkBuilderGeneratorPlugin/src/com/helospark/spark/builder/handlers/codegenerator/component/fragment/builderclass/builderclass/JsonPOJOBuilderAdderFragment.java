...
public class JsonPOJOBuilderAdderFragment {
    ...
    private String getBuilderMethodName() {
        return preferencesManager.getStringPreference(BUILD_METHOD_NAME_PATTERN);
    }

    private String getWithMethodPrefix() {
        String builderMethodNamePattern = preferencesManager.getStringPreference(BUILDERS_METHOD_NAME_PATTERN);
